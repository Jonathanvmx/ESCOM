...
// Declaraciones de las funciones del árbol
...
// Función para realizar el recorrido en amplitud del árbol
void recorridoAmplitud(Nodo* raiz) {
    if (raiz == NULL) {
        return;
    }
...
// Función para realizar el recorrido en inorden del árbol
void recorridoInorden(Nodo* raiz) {
    if (raiz != NULL) {
...
// Función para realizar el recorrido en postorden del árbol
void recorridoPostorden(Nodo* raiz) {
    if (raiz != NULL) {
